...
FIXED VERSION - Prevents action words from appearing in reasoning
"""
...
def extract_decision(response: str) -> str:
    ...
    # Split into lines and check from last to first
    ...
    # If both or neither appear, this is ambiguous
    return None
